...
public class ListPackagesPanel extends Panel {
	...
	protected void onInitialize() {
		...
		recipientFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		taxFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		userFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		DateTextField startDateFilt = new DateTextField("startDateFilter", new PropertyModel<>(this, "startDateFilter"),
				"dd-MM-yyyy");
		startDateFilt.add(new AjaxFormComponentUpdatingBehavior("change") {
		...
		startDateFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		DateTextField endDateFilt = new DateTextField("endDateFilter", new PropertyModel<>(this, "endDateFilter"),
				"dd-MM-yyyy");
		endDateFilt.add(new AjaxFormComponentUpdatingBehavior("change") {
		...
		endDateFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		descFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		countryFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
		...
		productFilt.add(new AjaxFormComponentUpdatingBehavior("keyup") {
